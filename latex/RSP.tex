...
through a process as shown in Figure~\ref{fig:blockdiag}. As long as the original optimization problem
...
\begin{figure}
    ...
    \begin{tikzpicture}[auto, align=center, text width=2.75cm, scale = 0.85]
        ...
        \node[block, name=reqs] at (0,0) (reqs) {Requirements \\ Resources};
