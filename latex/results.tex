...
that this aircraft is sensitive to the outcomes of the uncertain parameters. Then, using the
sensitivities of the nominal solution, we assign $3\sigma$ margins for each parameter,
and generate a design using margins.

These two solutions are compared with \gls{ro} results for box and elliptical uncertainty sets
at $\Gamma = 1$. We expect that
...
\hline
E[Objective] & expected total fuel weight & $\mathrm{N}$ & 964 & 976 & 856 \\
\hline
