...
& \begin{tabular}{c} sketches to scale \end{tabular} & &
    \begin{tabular}{c}\includegraphics[trim={9.5cm 2cm 8.5cm 2cm},clip,height=3.8cm]{figures/nominal.pdf}\end{tabular} &
    \begin{tabular}{c}\includegraphics[trim={9.5cm 2cm 8.5cm 2cm},clip,height=3.8cm]{figures/margins.pdf}\end{tabular} &
    \begin{tabular}{c}\includegraphics[trim={9.5cm 2cm 8.5cm 2cm},clip,height=3.8cm]{figures/box.pdf}\end{tabular} &
    \begin{tabular}{c}\includegraphics[trim={9.5cm 2cm 8.5cm 2cm},clip,height=3.8cm]{figures/elliptical.pdf}\end{tabular} \\
\hline
...
\begin{figure}[!h]
    ...
    \begin{tikzpicture}
        ...
        {\includegraphics[trim={2cm 0 1cm 0},clip,scale=0.6]{figures/4objradar.pdf}};
    ...
    \begin{center}
        \begin{subfigure}{0.4\linewidth}
            \makebox[\textwidth]{\begin{tikzpicture}
                ...
                {\includegraphics[trim={9.5cm 1cm 8.5cm 1cm},clip,height=3.8cm]{figures/0nominal.pdf}};
                \node[inner sep=0] (c) at (-1,0)
                {\includegraphics[trim={9.5cm 1cm 8.5cm 1cm},clip,height=3.8cm]{figures/0elliptical.pdf}};
                \node[inner sep=0] (r) at (.5,0)
                {\includegraphics[trim={9.5cm 1cm 8.5cm 1cm},clip,height=3.8cm]{figures/0box.pdf}};
            \end{tikzpicture}}
            \caption{Total fuel}
        \end{subfigure}
        \begin{subfigure}{0.4\linewidth}
            \makebox[\textwidth]{\begin{tikzpicture}
                \node[inner sep=0] (l) at (-2.5,0)
                {\includegraphics[trim={9.5cm 1cm 8.5cm 1cm},clip,height=3.8cm]{figures/1nominal.pdf}};
                \node[inner sep=0] (c) at (-1,0)
                {\includegraphics[trim={9.5cm 1cm 8.5cm 1cm},clip,height=3.8cm]{figures/1elliptical.pdf}};
                \node[inner sep=0] (r) at (.5,0)
                {\includegraphics[trim={9.5cm 1cm 8.5cm 1cm},clip,height=3.8cm]{figures/1box.pdf}};
            \end{tikzpicture}}
        ...
        \begin{subfigure}{0.4\linewidth}
            \makebox[\textwidth]{\begin{tikzpicture}
                \node[inner sep=0] (l) at (-2.5,0)
                {\includegraphics[trim={9.5cm 1cm 8.5cm 1cm},clip,height=3.8cm]{figures/2nominal.pdf}};
                \node[inner sep=0] (c) at (-1,0)
                {\includegraphics[trim={9.5cm 1cm 8.5cm 1cm},clip,height=3.8cm]{figures/2elliptical.pdf}};
                \node[inner sep=0] (r) at (.5,0)
                {\includegraphics[trim={9.5cm 1cm 8.5cm 1cm},clip,height=3.8cm]{figures/2box.pdf}};
            \end{tikzpicture}}
            \caption{Total cost}
        \end{subfigure}
        \begin{subfigure}{0.4\linewidth}
            \makebox[\textwidth]{\begin{tikzpicture}
                \node[inner sep=0] (l) at (-2.5,0)
                {\includegraphics[trim={9.5cm 1cm 8.5cm 1cm},clip,height=3.8cm]{figures/3nominal.pdf}};
                \node[inner sep=0] (c) at (-1,0)
                {\includegraphics[trim={9.5cm 1cm 8.5cm 1cm},clip,height=3.8cm]{figures/3elliptical.pdf}};
                \node[inner sep=0] (r) at (.5,0)
                {\includegraphics[trim={9.5cm 1cm 8.5cm 1cm},clip,height=3.8cm]{figures/3box.pdf}};
            \end{tikzpicture}}
