...
sketches to scale &
    \includegraphics[trim={10.5cm 1.5cm 10.5cm 1.5cm},clip,height=3.8cm]{objtable0.eps} &
    \includegraphics[trim={10.5cm 1.5cm 10.5cm 1.5cm},clip,height=3.8cm]{objtable1.eps} &
    \includegraphics[trim={10.5cm 1.5cm 10.5cm 1.5cm},clip,height=3.8cm]{objtable2.eps} &
    \includegraphics[trim={10.5cm 1.5cm 10.5cm 1.5cm},clip,height=3.8cm]{objtable3.eps} &
    ...
    \begin{center}
        \begin{subfigure}{0.4\linewidth}
            \makebox[\textwidth]{\begin{tikzpicture}
                ...
                {\includegraphics[]{0nominal.eps}};
                \node[inner sep=0] (c) at (-1,0)
                {\includegraphics[trim={10.5cm 2cm 10.5cm 2cm},clip,height=3.8cm]{0elliptical.eps}};
                \node[inner sep=0] (r) at (.5,0)
                {\includegraphics[trim={10.5cm 2cm 10.5cm 2cm},clip,height=3.8cm]{0box.eps}};
            \end{tikzpicture}}
            \caption{Total fuel}
        \end{subfigure}
        \begin{subfigure}{0.4\linewidth}
            \makebox[\textwidth]{\begin{tikzpicture}
                \node[inner sep=0] (l) at (-2.5,0)
                {\includegraphics[trim={10.5cm 2cm 10.5cm 2cm},clip,height=3.8cm]{1nominal.eps}};
                \node[inner sep=0] (c) at (-1,0)
                {\includegraphics[trim={10.5cm 2cm 10.5cm 2cm},clip,height=3.8cm]{1elliptical.eps}};
                \node[inner sep=0] (r) at (.5,0)
                {\includegraphics[trim={10.5cm 2cm 10.5cm 2cm},clip,height=3.8cm]{1box.eps}};
            \end{tikzpicture}}
        ...
        \begin{subfigure}{0.4\linewidth}
            \makebox[\textwidth]{\begin{tikzpicture}
                \node[inner sep=0] (l) at (-2.5,0)
                {\includegraphics[trim={10.5cm 2cm 10.5cm 2cm},clip,height=3.8cm]{2nominal.eps}};
                \node[inner sep=0] (c) at (-1,0)
                {\includegraphics[trim={10.5cm 2cm 10.5cm 2cm},clip,height=3.8cm]{2elliptical.eps}};
                \node[inner sep=0] (r) at (.5,0)
                {\includegraphics[trim={10.5cm 2cm 10.5cm 2cm},clip,height=3.8cm]{2box.eps}};
            \end{tikzpicture}}
            \caption{Total cost}
        \end{subfigure}
        \begin{subfigure}{0.4\linewidth}
            \makebox[\textwidth]{\begin{tikzpicture}
                \node[inner sep=0] (l) at (-2.5,0)
                {\includegraphics[trim={10.5cm 2cm 10.5cm 2cm},clip,height=3.8cm]{3nominal.eps}};
                \node[inner sep=0] (c) at (-1,0)
                {\includegraphics[trim={10.5cm 2cm 10.5cm 2cm},clip,height=3.8cm]{3elliptical.eps}};
                \node[inner sep=0] (r) at (.5,0)
                {\includegraphics[trim={10.5cm 2cm 10.5cm 2cm},clip,height=3.8cm]{3box.eps}};
            \end{tikzpicture}}
