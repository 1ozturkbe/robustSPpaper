...
As a demonstration, we take optimize aircraft for a range of $\Gamma$ with total cost
being the objective.

Interestingly enough, the relationship between total cost and

\begin{figure}
    \begin{center}
        \begin{tikzpicture}
            \node[inner sep=0] (0) at (0,0)
            {\includegraphics[height=5cm]{figures/fuse0.pdf}};
            \node[inner sep=0] (1) at (0,0)
            {\includegraphics[height=5cm]{figures/fuse1.pdf}};
            \node[inner sep=0] (2) at (1.5,0)
            {\includegraphics[height=5cm]{figures/fuse2.pdf}};
            \node[inner sep=0] (3) at (3,0)
            {\includegraphics[height=5cm]{figures/fuse3.pdf}};
            \node[inner sep=0] (4) at (4.5,0)
            {\includegraphics[height=5cm]{figures/fuse4.pdf}};
            \node[inner sep=0] (5) at (6,0)
            {\includegraphics[height=5cm]{figures/fuse5.pdf}};
            \node[inner sep=0] (6) at (7.5,0)
            {\includegraphics[height=5cm]{figures/fuse6.pdf}};
            \node[inner sep=0] (7) at (9,0)
            {\includegraphics[height=5cm]{figures/fuse7.pdf}};
            \node[inner sep=0] (8) at (10.5,0)
            {\includegraphics[height=5cm]{figures/fuse8.pdf}};
            \node[inner sep=0] (9) at (12,0)
            {\includegraphics[height=5cm]{figures/fuse9.pdf}};
            \node[inner sep=0] (10) at (13.5,0)
            {\includegraphics[height=5cm]{figures/fuse10.pdf}};
        \end{tikzpicture}
    \end{center}
    \caption{Showing the fuselage evolution of aircraft designed for
    different $\Gamma$s.}
\end{figure}
...
the engineering design process. \gls{rsp}s allow engineers to inject
