...
& \begin{tabular}{c} sketches to scale \end{tabular} & &
    \begin{tabular}{c}\includegraphics[trim={9.5cm 2cm 8.5cm 2cm},clip,height=3.8cm]{figures/nominal.eps}\end{tabular} &
    \begin{tabular}{c}\includegraphics[trim={9.5cm 2cm 8.5cm 2cm},clip,height=3.8cm]{figures/margins.eps}\end{tabular} &
    \begin{tabular}{c}\includegraphics[trim={9.5cm 2cm 8.5cm 2cm},clip,height=3.8cm]{figures/box.eps}\end{tabular} &
    \begin{tabular}{c}\includegraphics[trim={9.5cm 2cm 8.5cm 2cm},clip,height=3.8cm]{figures/elliptical.eps}\end{tabular} \\
\hline
...
\begin{figure}[!h]
    ...
    \begin{tikzpicture}
        ...
        {\includegraphics[trim={2cm 0 1cm 0},clip,scale=0.6]{figures/4objradar.eps}};
        \node[inner sep=0] (ul) at (-1.0, 0.25)
        {\includegraphics[height=3.8cm]{figures/0nominal.eps}};
        \node[inner sep=0] (ur) at (1.0, 0.25)
        {\includegraphics[height=3.8cm]{figures/1nominal.eps}};
        \node[inner sep=0] (ll) at (-1.0, -2)
        {\includegraphics[height=3.8cm]{figures/2nominal.eps}};
        \node[inner sep=0] (lr) at (1.0, -2)
        {\includegraphics[height=3.8cm]{figures/3nominal.eps}};
    \end{tikzpicture}
    ...
    \begin{center}
        \begin{subfigure}{0.4\linewidth}
            \makebox[\textwidth]{\begin{tikzpicture}
                ...
                {\includegraphics[trim={9.5cm 1cm 8.5cm 1cm},clip,height=3.8cm]{figures/0nominal.eps}};
                \node[inner sep=0] (c) at (-1,0)
                {\includegraphics[trim={9.5cm 1cm 8.5cm 1cm},clip,height=3.8cm]{figures/0elliptical.eps}};
                \node[inner sep=0] (r) at (.5,0)
                {\includegraphics[trim={9.5cm 1cm 8.5cm 1cm},clip,height=3.8cm]{figures/0box.eps}};
            \end{tikzpicture}}
            \caption{Total fuel}
        \end{subfigure}
        \begin{subfigure}{0.4\linewidth}
            \makebox[\textwidth]{\begin{tikzpicture}
                \node[inner sep=0] (l) at (-2.5,0)
                {\includegraphics[trim={9.5cm 1cm 8.5cm 1cm},clip,height=3.8cm]{figures/1nominal.eps}};
                \node[inner sep=0] (c) at (-1,0)
                {\includegraphics[trim={9.5cm 1cm 8.5cm 1cm},clip,height=3.8cm]{figures/1elliptical.eps}};
                \node[inner sep=0] (r) at (.5,0)
                {\includegraphics[trim={9.5cm 1cm 8.5cm 1cm},clip,height=3.8cm]{figures/1box.eps}};
            \end{tikzpicture}}
        ...
        \begin{subfigure}{0.4\linewidth}
            \makebox[\textwidth]{\begin{tikzpicture}
                \node[inner sep=0] (l) at (-2.5,0)
                {\includegraphics[trim={9.5cm 1cm 8.5cm 1cm},clip,height=3.8cm]{figures/2nominal.eps}};
                \node[inner sep=0] (c) at (-1,0)
                {\includegraphics[trim={9.5cm 1cm 8.5cm 1cm},clip,height=3.8cm]{figures/2elliptical.eps}};
                \node[inner sep=0] (r) at (.5,0)
                {\includegraphics[trim={9.5cm 1cm 8.5cm 1cm},clip,height=3.8cm]{figures/2box.eps}};
            \end{tikzpicture}}
            \caption{Total cost}
        \end{subfigure}
        \begin{subfigure}{0.4\linewidth}
            \makebox[\textwidth]{\begin{tikzpicture}
                \node[inner sep=0] (l) at (-2.5,0)
                {\includegraphics[trim={9.5cm 1cm 8.5cm 1cm},clip,height=3.8cm]{figures/3nominal.eps}};
                \node[inner sep=0] (c) at (-1,0)
                {\includegraphics[trim={9.5cm 1cm 8.5cm 1cm},clip,height=3.8cm]{figures/3elliptical.eps}};
                \node[inner sep=0] (r) at (.5,0)
                {\includegraphics[trim={9.5cm 1cm 8.5cm 1cm},clip,height=3.8cm]{figures/3box.eps}};
            \end{tikzpicture}}
