...
in the design optimization problem is violated when the uncertain parameters are simulated.
...
To further demonstrate the capabilities of \gls{rsp}s in aircraft design,
