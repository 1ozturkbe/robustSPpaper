...
& \begin{tabular}{c} sketches to scale \\ \\ \\ \\ \end{tabular} & &
    \includegraphics[trim={9.5cm 1cm 9.5cm 1cm},clip,height=3.8cm]{figures/nominal.eps} &
    \includegraphics[trim={9.5cm 1cm 9.5cm 1cm},clip,height=3.8cm]{figures/margins.eps} &
    \includegraphics[trim={9.5cm 1cm 9.5cm 1cm},clip,height=3.8cm]{figures/box.eps} &
    \includegraphics[trim={9.5cm 1cm 9.5cm 1cm},clip,height=3.8cm]{figures/elliptical.eps} \\
\hline
