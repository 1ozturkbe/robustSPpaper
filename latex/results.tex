...
\hline
& 0.00 & $2.5 \times 10^{-4}$ & 0.92 & & - & - & - \\
& 0.10 & 0.057 & 0.82 & & - & - & - \\
& 0.20 & 0.118 & 0.72 & & - & - & - \\
& 0.30 & 0.183 & 0.49 & & 0.183 & 0.30 & 0.69 \\
& 0.40 & 0.252 & 0.35 & & 0.252 & 0.40 & 0.63 \\
& 0.50 & 0.326 & 0.24 & & 0.326 & 0.50 & 0.50 \\
& 0.60 & 0.406 & 0.15 & & 0.406 & 0.60 & 0.36 \\
& 0.70 & 0.492 & 0.05 & & 0.492 & 0.70 & 0.22 \\
& 0.80 & 0.583 & 0.01 & & 0.583 & 0.80 & 0.08 \\
& 0.90 & 0.681 & 0.00 & & 0.681 & 0.90 & 0.06 \\
& 1.00 & 0.787 & 0.00 & & 0.787 & 1.0 & 0.04 \\
\end{tabular}
\end{center}
\end{table}

Firstly, note that there are no results reported for the three smallest uncertainty sets $\Gamma = [0.00, 0.10, 0.20]$.
This is because the feasible set of the goal problem was small enough that the signomial program
...
However, there are discrepancies in the probability of failure, for the same set of \gls{mc} samples.
This is no surprise, since the added objective penalty constraint restricts the feasible set of uncertain
realizations further than the original problem. For example, in the case of the objective of low fuel consumption,
a lower-than-mean payload mass or higher-than-mean payload density may allow for higher fuel consumption
than the robust solution. This solution would be feasible for the original method but not the
goal programming method. From this perspective, the original \gls{ro} method is more
appropriate for probability of failure analyses.
In either case, the probability of failure found is strictly more conservative using the goal programming method,
and is consistent with our expectations,
being monotonic with the size of the uncertainty set.
