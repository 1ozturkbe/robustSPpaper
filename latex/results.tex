...
It is noteworthy in Table~\ref{tab:results} that, for the nominal problem ($\Gamma = 0$),
...
in all other objectives under uncertainty. This means that robust requirements can
...
they allows engineers to understand these kinds of complex trade-offs early on in the design process.
