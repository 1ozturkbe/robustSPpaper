\begin{abstract}
    ...
    Traditional methods of capturing uncertainty do not adequately
    ...
    The formulation leverages an existing approximate robust geometric programming (RGP)
    ...
    the formulation of robust signomial programs (RSPs) allows
    ...
    rigorously by implementing RSPs on a simple aircraft design problem, and evaluates the effect of robustness
