...
Each posynomial term is divided into an equivalent set of smaller posynomials based on the dependence between its monomial terms.
...
\begin{figure}
    \begin{center}
        \begin{tikzpicture}[auto, align=center,scale = 0.9]
...
The posynomial constraints are categorized into three sets: monomials, two-term posynomials, and large posynomials.
