...
by sequentially solving local GP approximations, but the solution is not guaranteed
to be globally optimal. Our approach to solve an RSP is based on sequentially solving
local RGP approximations. Below we provide a step-by-step algorithm to solve an RSP:
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item Solve the approximate tractable counterparts of the local GP in
