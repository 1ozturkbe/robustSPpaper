...
state of markets and regulatory agencies. Design
under uncertainty for aircraft presents
low hanging fruit, since the program risk of aircraft design
problems is high and the goal of these methods is to provide designs that are robust
...
Zang et al.\cite{Zang2002} succinctly
describe the categories of benefits for optimization under uncertainty for aircraft.
...
However, optimization under uncertainty has yet to gain significant traction in the aerospace field.
...
and that risk aversity necessarily results in lower performance.
...
however there is a growing body of research on distributionally robust optimization~\cite{Bertsimas2013}
