...
{\color{blue}There have been recent developments in multi-mission design that improve its effectiveness.
...
\begin{center}
    ...
    \centering
        \includegraphics[width=.8\linewidth]{figures/ouc.PNG}
    \end{subfigure}
    \begin{subfigure}{.49\textwidth}
    \centering
        \includegraphics[width=.9\linewidth]{figures/so.PNG}
    \end{subfigure}
    \begin{subfigure}{.49\textwidth}
    \centering
        \includegraphics[width=.9\linewidth]{figures/ro.PNG}
    \end{subfigure}
