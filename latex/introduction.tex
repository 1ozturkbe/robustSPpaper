...
which seeks to leverage existing data. And \gls{ro} does sacrifice the ability to
obtain distributional information about measures of performance, which is accepted
...
using simulations of the uncertain parameters.
