...
Signomial programming can cover constraints that might be neither linear, convex, nor log-covex and, hence,
it can be used to model problems that cannot be formulated by standard optimization tools such as linear
or geometric programs.

Signomial programming
is a powerful tool that is currently being used in modeling and solving complex aircraft designs quickly
and reliably as in \cite{york_hoburg_drela_2018} \cite{kirschen_burnell_hoburg_2016} \cite{kirschen_york_ozturk_hoburg_2018}.
...
Reliably solving an SP to a local optimum has been described in \cite{GP_tutorial} and \cite{lipp_boyd_2015}.
